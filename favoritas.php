...
<body>
    <div class="container">
        ...
        <?php require_once "./libs/menuFavoritas.php"; ?>
        ...
        <div class="container mt-4">
            ...
            $sql= "SELECT Ginebra.* FROM Favorita 
                    JOIN Ginebra ON Favorita.idGin = Ginebra.idGin
                    WHERE Favorita.idUsu = '{$idUsu}';";
            ...
            if($ginebrasResult->num_rows <= 0):
                echo "<div class=\"alert alert-warning text-center mt-4\" role=\"alert\">
                        ...
                        <strong>¡Ups!</strong> No tienes ginebras favoritas en este momento.  
                    </div>";
            else:
            ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="container text-center">
                                    <div class="row row-cols-3 ">
                                        ...
                                        <div class="col">
                                            <label class="heart">
                                                <a href="meGusta.php?idGin=<?= $ginebra['idGin']?>&checked=checked&fav=fav">
