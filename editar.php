...
<body>
    <div class="container">
        ...
        <form class="formulario" action="editarGin.php?idGin=<?= $ginebra->idGin ?>" method="POST">
            <div class="card">
                <img src="<?= $ginebra->imagen ?>" alt="Foto de Ginebra" class="card-img">
                <div class="card-body text-start">
                    <label for="nombre">Nombre</label><input type="text" class="form-control" name="nombre" value="<?= $ginebra->nombre ?>" required>
                    <div class="container text-start">
                        <div class="row row-cols-2 m-4">
                            <div class="col"><label for="tipo">Tipo</label></div>
                            <div class="col"><label for="pais">Pais</label></div>
                            <div class="col"><input type="text" class="form-control fw-lighter" name="tipo" value="<?= $ginebra->tipo ?>" required></div>
                            <div class="col"><input type="text" class="form-control fw-lighter" name="pais" value="<?= $ginebra->pais ?>" required></div>
                        </div>
                    </div>
                    <div class="container text-start">
                        <div class="row row-cols-2 m-4">
                            ...
                            <div class="col">
                                <div class="col"><input type="text" class="form-control fw-lighter" name="precio" value="<?= $ginebra->precio ?>" required></div>
                            </div>
                            <div class="col">
                                <div class="col"><input type="text" class="form-control fw-lighter" name="alcohol" value=" <?= $ginebra->alcohol ?>" required></div>
                    ...
                    <div class="text-start m-4">
                        <div class="row m-4">
                            <div class="col">
                                ...
                                <input type="text" class="form-control fw-lighter" name="imagen" value="<?= $ginebra->imagen ?>" required> </div>
                            </div>    
                            <div class="row m-4">
                            <div class="col">
                                <label for="descripcion">Descripcion</label>
                                <textarea class="fw-lighter" name="descripcion" id="descripcion" rows="3" cols="60" required><?= $ginebra->descripcion ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="container text-center">
                        <div class="row m-2">
                            ...
                            <div class="col m-2">
                                <a href="info.php?idGin=<?= $ginebra->idGin ?>" class="btn btn-dark"> Volver </a>
                            </div>
                        </div>
                    </div>
